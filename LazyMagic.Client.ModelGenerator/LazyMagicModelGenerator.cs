        ...
        try
        {
            foreach (var syntaxTree in context.Compilation.SyntaxTrees)
            {
                ...
                var classesWithFactoryAttribute = syntaxTree.GetRoot()
                    ...
                    .Where(x => model.GetDeclaredSymbol(x)!.GetAttributes().Any(a => a.AttributeClass!.Name == nameof(LzModelAttribute)));
...
public partial class {baseClassName}Model : {baseClassName}, IRegisterObservables
{{
}}
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
";
                    context.AddSource($"{baseClassName}Model.g.cs", source);
                }
